...
| <a name="input_source_arn"></a> [source\_arn](#input\_source\_arn) | The ARN of the source for the SQS queue. | `string` | n/a | yes |
| <a name="input_consumer_accounts"></a> [consumer\_accounts](#input\_consumer\_accounts) | A List of the the AWS account ARN or a shortened form with the account ID. | `list(any)` | `[]` | no |
